file_input = "/media/sreeganesh/Windows/Users/GMachine/Documents/Studies/S7/NTC/NTC_Assignment/Transposition/cryptanalysis/chosenCT/input.txt"
file_output = "/media/sreeganesh/Windows/Users/GMachine/Documents/Studies/S7/NTC/NTC_Assignment/Transposition/cryptanalysis/chosenCT/output.txt"
...
def main():
    with open (file_input, 'rt') as myfile:
        for line in myfile:
            ...
            elif line.find("plainText1") != -1:
                plainText1 = (line.rstrip('\n').split(" = ")[1]).lower()
            elif line.find("plainText2") != -1:
                plainText2 = (line.rstrip('\n').split(" = ")[1]).lower()
